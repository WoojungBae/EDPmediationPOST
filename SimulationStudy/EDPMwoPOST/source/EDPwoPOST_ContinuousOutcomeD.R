...
setwd("C:/Users/WooJung/Documents/Rproject/EDPmediationpost/SimulationStudy/EDPMwoPOST/source")

# This code must be in your current directory or you can change the path.
# Load cpp code
sourceCpp("EDPwoPOSTsource_cpp.cpp")
# Load R code
source("EDPwoPOSTsource_r.R")
...
EDPmediation_result = EDPmediation(Y, M, Z, C, gibbs_iter, gibbs_burnin, gibbs_thin, 
